...
setup(
    ...
    version=VERSION,
    description="Continuous Integration Reference Python API",
    ...
    zip_safe=False,
    long_description="""CIRPA is a set of tools and a design pattern for creating a dynamic command line tool used for CI strategies""",
    entry_points="""
        [console_scripts]
        cirpa-run=cirpa.run:main
                    """,
    classifiers=[
        # Picked from
